...
const getServiceData = (serviceId: string): ServiceData | null => {
  const services: Record<string, ServiceData> = {
    "cat-toc-nam": {
      ...
      image: "/images/cat-toc-nam.jpg", // Replace with actual image path
      features: [
      ...
      styles: [
        {
          ...
          image: "/images/classic-business.jpg", // Replace with actual image path
          difficulty: "Dễ",
          maintenance: "Thấp",
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${serviceData.title} - Dịch Vụ Tóc Nam - Winchair Beauty Spa`,
      description: serviceData.description,
      url: `https://www.winchairbeautyspa.com/dich-vu-toc-nam/${serviceData.id}`,
      siteName: "Winchair Beauty Spa",
      images: [
        {
          url:
            serviceData.image ||
            "https://www.winchairbeautyspa.com/images/default.jpg",
          width: 800,
          height: 600,
...
export default function ServicePage({
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src={serviceData.image || "/images/default.jpg"}
                  alt={serviceData.title}
      ...
      {/* Popular Styles (Conditional Rendering) */}
      {allStyles.length > 0 && (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {popularStyles.length > 0 ? (
                  ...
                  >
                    <div className="bg-white/5 backdrop-blur-xl rounded-xl overflow-hidden border border-white/10 hover:border-blue-400/30 transition-all duration-300">
                      <div className="aspect-[3/4] overflow-hidden">
                        <img
                          src={style.image || "/images/default.jpg"}
                          alt={style.name}
              ...
              <p className="text-center text-gray-400">
                Hiện không có mẫu tóc phổ biến nào cho dịch vụ này.
              </p>
            )}
      ...
      {/* All Styles (Conditional Rendering) */}
      {allStyles.length > 0 && (
        <section
          id="all-styles"
