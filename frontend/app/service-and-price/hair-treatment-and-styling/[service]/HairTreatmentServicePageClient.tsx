        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-gray-500 overflow-x-auto">
            ...
            <li className="flex items-center">
              ...
              <Link
                href="/service-and-price/hair-treatment-and-styling"
          ...
          <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
                Most popular treatments for the service {serviceData.title.toLowerCase()}
              </p>
            </div>
                    ...
                    <div key={slideIndex} className="w-full flex-shrink-0">
                      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                        {displayedPopularStyles
                          ...
                          .map((style, index) => (
                            <Link
                              href={`/service-and-price/hair-treatment-and-styling/${serviceData.id}/${style.id}`}
                              key={index}
                              ...
                              <div className="bg-white rounded-lg sm:rounded-xl overflow-hidden border border-amber-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300">
                                ...
                                <div className="p-2.5 sm:p-3 md:p-4">
                                  ...
                                  <div className="flex items-center justify-between text-xs">
                                    <span className="text-gray-400">Difficulty: {style.difficulty}</span>
                                    <span className="text-gray-400">Maintenance: {style.maintenance || "N/A"}</span>
                                  </div>
                                </div>
                              </div>
                            </Link>
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-amber-100 shadow-lg">
              <h2 className="text-lg sm:text-xl md:text-2xl font-light text-gray-800 mb-4 sm:mb-6">Services Included</h2>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 border border-amber-100 shadow-lg">
              <h2 className="text-lg sm:text-xl md:text-2xl font-light text-gray-800 mb-4 sm:mb-6">Benefit</h2>
              <ul className="space-y-4">
        ...
        <div className="max-w-5xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 border border-amber-200 shadow-xl">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Book an appointment today to experience the service {serviceData.title.toLowerCase()}{" "}
              {allStyles.length > 0 ? `with ${allStyles.length} diverse treatment methods` : ""} at Winchair Beauty
              Spa.
            </p>
