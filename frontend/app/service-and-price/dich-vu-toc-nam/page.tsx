//app/service-and-price/dich-vu-toc-nam/page.tsx
"use client";
...
const MensHairServicesPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Dịch Vụ Tóc Nam - Winchair Beauty Spa | Phong Cách Đỉnh Cao
        </title>
        <meta
          name="description"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              {services.map((service, index) => (
                <Link
                  href={`/service-and-price/dich-vu-toc-nam/${service.id}`}
                  key={index}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-blue-400/20">
                  ...
                  <p className="text-gray-400 text-sm">
                    Đội ngũ stylist nam giàu kinh nghiệm, hiểu rõ xu hướng và
                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-blue-400/20">
                  ...
                  <p className="text-gray-400 text-sm">
                    Dịch vụ hiệu quả, tiết kiệm thời gian cho lịch trình bận rộn
                    của quý ông.
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-blue-400/20">
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-black to-slate-900/80">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-8 sm:p-12 border border-white/10">
              <h2 className="text-2xl sm:text-4xl font-light text-white mb-6">
                Sẵn Sàng Cho Phong Cách Mới?
              </h2>
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Đặt lịch ngay hôm nay để trải nghiệm dịch vụ tóc nam chuyên
