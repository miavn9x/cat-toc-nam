...
const EstheticServicesPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Dịch Vụ Thẩm Mỹ - Winchair Beauty Spa | Rạng Rỡ Tự Nhiên</title>
        <meta
          name="description"
          content="Dịch vụ thẩm mỹ chuyên nghiệp tại Winchair Beauty Spa - Chăm sóc da mặt, Tẩy lông, Nối mi, Microblading với giá từ $16. Rạng rỡ tự nhiên tại Etobicoke, Ontario."
        />
        <meta
          name="keywords"
          content="chăm sóc da mặt, tẩy lông, nối mi, microblading, thẩm mỹ Etobicoke, Winchair Beauty Spa"
        />
      </Head>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12">
              {services.map((service, index) => (
                <Link href={`/service-and-price/dich-vu-tham-my/${service.id}`} key={index} className="group block">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <span className="text-emerald-400 text-sm font-medium">
                            {service.styleCount > 0 ? `Xem ${service.styleCount} kiểu dáng` : "Xem chi tiết"}
                          </span>
                          <svg
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-4xl font-light text-white mb-6">
                Tại Sao Chọn Dịch Vụ Thẩm Mỹ Của Chúng Tôi?
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-emerald-400/20">
                  <div className="text-3xl mb-4">✨</div>
                  <h3 className="text-lg font-medium text-emerald-300 mb-3">Rạng Rỡ Tự Nhiên</h3>
                  <p className="text-gray-400 text-sm">
                    Nâng cao vẻ đẹp tự nhiên của bạn với các liệu trình chăm sóc chuyên nghiệp và sản phẩm cao cấp.
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-emerald-400/20">
                  <div className="text-3xl mb-4">🧘‍♀️</div>
                  <h3 className="text-lg font-medium text-emerald-300 mb-3">Thư Giãn Sâu</h3>
                  <p className="text-gray-400 text-sm">
                    Trải nghiệm thư giãn tối đa trong không gian yên tĩnh và dịch vụ chăm sóc tận tâm.
                  </p>
                </div>
                <div className="bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-emerald-400/20">
                  <div className="text-3xl mb-4">🎯</div>
                  <h3 className="text-lg font-medium text-emerald-300 mb-3">Kết Quả Thực Tế</h3>
                  <p className="text-gray-400 text-sm">
                    Đạt được kết quả rõ rệt và lâu dài với kỹ thuật chuyên nghiệp và sản phẩm chất lượng cao.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-br from-black to-slate-900/80">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-8 sm:p-12 border border-white/10">
              <h2 className="text-2xl sm:text-4xl font-light text-white mb-6">Sẵn Sàng Rạng Rỡ Tự Nhiên?</h2>
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                Đặt lịch ngay hôm nay để trải nghiệm dịch vụ thẩm mỹ chuyên nghiệp tại Winchair Beauty Spa.
              </p>
