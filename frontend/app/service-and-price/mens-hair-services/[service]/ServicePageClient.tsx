...
export default function ServicePageClient({
  ...
  const allStyles = DataService.getServiceStyles("men-hair", params.service);
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-gray-400 overflow-x-auto">
            ...
            <li className="flex items-center">
              ...
              <Link
                href="/service-and-price/mens-hair-services"
                className="ml-2 hover:text-blue-300 transition-colors"
              >
                Men&#39;s Hair Services
              </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 items-start">
            <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col xs:flex-row sm:flex-row gap-3 sm:gap-4 md:gap-6">
                <Link
                  href="/booking"
                  className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-blue-500/25 transition-all text-center text-sm sm:text-base"
                >
                  Book Now
                </Link>
                <Link
                  href="/contact"
                  className="px-6 sm:px-8 py-2.5 sm:py-3 border border-blue-400/50 text-blue-300 rounded-full hover:bg-blue-400/10 transition-all text-center text-sm sm:text-base"
                >
                    ...
                    {serviceData.images.map((image, index) => (
                      <button
                        ...
                        className={`relative rounded-md sm:rounded-lg overflow-hidden aspect-square transition-all duration-300 ${
                          selectedImage === index
                            ? "ring-1 sm:ring-2 ring-blue-400 ring-offset-1 sm:ring-offset-2 ring-offset-slate-900"
                    ...
                    <div key={slideIndex} className="w-full flex-shrink-0">
                      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                        {displayedPopularStyles
                          ...
                          .map((style, index) => (
                            <Link
                              href={`/service-and-price/mens-hair-services/${serviceData.id}/${style.id}`}
                              key={index}
                              className="group block"
                            >
                              <div className="bg-white/5 backdrop-blur-xl rounded-lg sm:rounded-xl overflow-hidden border border-white/10 hover:border-blue-400/30 transition-all duration-300">
                                ...
                                <div className="p-2.5 sm:p-3 md:p-4">
                                  <div className="flex items-center justify-between mb-1.5 sm:mb-2">
                                    <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-white group-hover:text-blue-300 transition-colors line-clamp-1">
                                      {style.name}
                                    </h3>
                                    <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-blue-500/20 text-blue-300 text-xs rounded-full flex-shrink-0">
                                      Popular
                                    </span>
                                  </div>
              ...
              {displayedAllStyles.map((style, index) => (
                ...
                >
                  <div className="bg-white/5 backdrop-blur-xl rounded-lg sm:rounded-xl overflow-hidden border border-white/10 hover:border-blue-400/30 transition-all duration-300">
                    ...
                    <div className="p-2.5 sm:p-3 md:p-4">
                      <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-medium text-white group-hover:text-blue-300 transition-colors mb-2 line-clamp-1">
                        {style.name}
                      </h3>
                      <p className="text-gray-400 text-xs sm:text-sm line-clamp-2 mb-2 sm:mb-3">
                        {style.description}
                      ...
                      <div className="space-y-1 sm:space-y-2">
                        ...
                        <div className="text-xs">
                          ...
                          <span className="text-blue-300 line-clamp-1">
                            {style.faceShape ? style.faceShape.join(", ") : ""}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <button
                    ...
                    className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-md overflow-hidden transition-all flex-shrink-0 ${
                      modalImageIndex === index
                        ? "ring-1 sm:ring-2 ring-blue-400"
