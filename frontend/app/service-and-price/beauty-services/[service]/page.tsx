...
import EstheticServicePageClient from "./EstheticServicePageClient"
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords: `${serviceData.title}, cosmetic services, Winchair Beauty Spa`,
  }
}

export default async function EstheticServicePage({
  params,
}: {
  params: Promise<{ service: string }>
}) {
  ...
  return <EstheticServicePageClient params={{ service }} />
}
